...
for name in imdb_files_list:
    if not os.path.exists('./data/' + name):
        ...
        with gzip.open('./data/' + name) as comp_file, open('./data/' + name[:-3], 'wb') as reg_file:
...
with open("./data/ratings.list", encoding='latin1') as myfile:
...
with open("./data/genres.list", encoding='latin1') as myfile:
...
with open("./data/genres.list", encoding='latin1') as genres_file:
...
with open("./data/ratings.list", encoding='latin1') as ratings_file:
